...
def find_causalnet(
    ...
    **kwargs : dict, optional
    ...
    c_node_penalties = {k: node_penalties.get(k, missing_penalty) + rng.uniform(edge_penalty/100, edge_penalty/10)
    ...
    W = rng.uniform(min_penalty/100, min_penalty/10, size=E.shape)
